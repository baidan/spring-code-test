...
import com.baidan.springCode.module.spring.demo4.entity.Pig;
...
public class Demo4ImportBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        boolean b1 = registry.containsBeanDefinition("com.baidan.springCode.module.spring.demo4.entity.Cat");
        boolean b2 = registry.containsBeanDefinition("com.baidan.springCode.module.spring.demo4.entity.Dog");
        if (b1 && b2) {
